...
class UserInfosControllerTest < ActionController::TestCase
  ...
  test "should create user_info" do
    assert_difference('UserInfo.count') do
      post :create, user_info: { email: @user_info.email, first_name: @user_info.first_name, last_name: @user_info.last_name, phone: @user_info.phone }
    end
  ...
  test "should update user_info" do
    patch :update, id: @user_info, user_info: { email: @user_info.email, first_name: @user_info.first_name, last_name: @user_info.last_name, phone: @user_info.phone }
    assert_redirected_to user_info_path(assigns(:user_info))
  end
